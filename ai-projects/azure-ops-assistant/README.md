...
*This experiment was conducted entirely within a personal, isolated Azure Pay-As-You-Go account. No production systems, real client data, or shared infrastructure were involved at any point. The tools, methods, and workflows documented here should not be used in a production environment. The experiment is the warning.*
